# Design Guidelines - html-taskboard
...
|------------|-----------|----------------|-------|
| Primary | `#4A90D9` | `bg-[#4A90D9]`, `text-[#4A90D9]`, `border-[#4A90D9]` | Main CTA buttons, links, active states |
| Primary Dark | `#1E293B` | `bg-[#1E293B]`, `hover:bg-[#1E293B]` | Button hover states, dark backgrounds |
| Primary Light | `#4A90D9/10` | `bg-[#4A90D9]/10` | Backgrounds, subtle highlights, selected items |

### 1.2 Semantic Colors

| Color Name | Hex Value | Tailwind Class | Usage |
|------------|-----------|----------------|-------|
| Success | `#10B981` | `bg-[#10B981]`, `text-emerald-600` | Success messages, positive indicators |
| Warning | `#F59E0B` | `bg-[#F59E0B]`, `text-amber-600` | Warning messages, caution states |
| Error | `#EF4444` | `bg-[#EF4444]`, `text-red-600` | Error messages, destructive actions |
| Info | `#4A90D9` | `bg-[#4A90D9]`, `text-blue-600` | Info messages, neutral highlights |
| Purple | `#8B5CF6` | `bg-[#8B5CF6]`, `text-purple-600` | Labels, accents |

### 1.3 Neutral Palette

| Color Name | Hex Value | Tailwind Class | Usage |
|------------|-----------|----------------|-------|
| Dark | `#1E293B` | `text-[#1E293B]` | Primary text, headings |
| Slate | `#64748B` | `text-[#64748B]` | Secondary text, descriptions |
| Muted | `#94A3B8` | `text-[#94A3B8]` | Muted text, placeholders |
| Border | `#E5E7EB` | `border-[#E5E7EB]`, `bg-[#E5E7EB]` | Borders, dividers |
| Light BG 1 | `#F9FAFB` | `bg-[#F9FAFB]` | Page backgrounds |
| Light BG 2 | `#F1F5F9` | `bg-[#F1F5F9]` | Section backgrounds |
| Light BG 3 | `#F8FAFC` | `bg-[#F8FAFC]` | Subtle backgrounds |
| Light BG 4 | `#F3F4F6` | `bg-[#F3F4F6]` | Hover states |
| White | `#FFFFFF` | `bg-white`, `text-white` | Card backgrounds, button text |
...
|------|-------------|-------------------|----------------|
| Primary | Inter | 400, 500, 600, 700 | `font-sans` |
| Monospace | System Mono | 400, 500, 600 | `font-mono` |

**CDN Link:** `https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap`
...
| Standard | 200ms | `duration-200` | **Default transition** - most UI interactions |
| Medium | 300ms | `duration-300` | Dropdown, modal open/close |
| Slow | 500ms | `duration-500` | Large layout changes, page transitions |
