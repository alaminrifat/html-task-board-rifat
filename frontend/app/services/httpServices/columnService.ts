...
export const columnService = {
  ...
  update: (projectId: string, columnId: string, data: UpdateColumnRequest) =>
    httpService.patch<Column>(`/projects/${projectId}/columns/${columnId}`, data),

  delete: (projectId: string, columnId: string) =>
    httpService.delete<void>(`/projects/${projectId}/columns/${columnId}`),

  reorder: (projectId: string, data: ReorderColumnsRequest) =>
    httpService.patch<Column[]>(`/projects/${projectId}/columns/reorder`, data),
};
