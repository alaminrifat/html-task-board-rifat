...
export const timeEntryService = {
  list: (projectId: string, taskId: string) =>
    httpService.get<TimeEntry[]>(`/projects/${projectId}/tasks/${taskId}/time-entries`),

  create: (projectId: string, taskId: string, data: CreateTimeEntryRequest) =>
    httpService.post<TimeEntry>(`/projects/${projectId}/tasks/${taskId}/time-entries`, data),

  start: (projectId: string, taskId: string) =>
    httpService.post<TimeEntry>(`/projects/${projectId}/tasks/${taskId}/time-entries/start`),
