...
export const memberService = {
  ...
  declineInvitation: (token: string) =>
    httpService.post<{ message: string }>(
  ...
  acceptInvitationByProject: (projectId: string) =>
    httpService.post<Invitation>(
      `/invitations/project/${projectId}/accept`,
    ),
  declineInvitationByProject: (projectId: string) =>
    httpService.post<Invitation>(
      `/invitations/project/${projectId}/decline`,
    ),
};
